...
namespace VolunteerSystem.Tests
{
    ...
    public class VolunteerTests
    {
        ...
        public void VolunteerTest(string name, string email, string Association)
        {
            Volunteer volunteer = new Volunteer(true, name, email, Association);

            Assert.AreEqual(volunteer.Name, name);
            Assert.AreEqual(volunteer.Email, email);
            Assert.AreEqual(volunteer.Association, Association);
        }
        ...
        public void ToStringTest(string name, string email, string Association, string actual)
        {
            Volunteer volunteer = new Volunteer(true, name, email, Association);
